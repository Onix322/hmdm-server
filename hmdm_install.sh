...
cat ./install/context_template.xml | sed "s|_SQL_HOST_|$SQL_HOST|g; s|_SQL_PORT_|$SQL_PORT|g; s|_SQL_BASE_|$SQL_BASE|g; s|_SQL_USER_|$SQL_USER|g; s|_SQL_PASS_|$SQL_PASS|g; s|_BASE_DIRECTORY_|$LOCATION|g; s|_PROTOCOL_|$PROTOCOL|g; s|_BASE_HOST_|$BASE_HOST|g; s|_BASE_DOMAIN_|$BASE_DOMAIN|g; s|_BASE_PATH_|$BASE_PATH|g; s|_INSTALL_FLAG_|$INSTALL_FLAG_FILE|g; s|_SMTP_HOST_|$SMTP_HOST|g; s|_SMTP_PORT_|$SMTP_PORT|g; s|_SMTP_SSL_|$SMTP_SSL|g; s|_SMTP_STARTTLS_|$SMTP_STARTTLS|g; s|_SMTP_USERNAME_|$SMTP_USERNAME|g; s|_SMTP_PASSWORD_|$SMTP_PASSWORD|g; s|_SMTP_FROM_|$SMTP_FROM|g; s|_OIDC_ENABLE_|$OIDC_ENABLE|g; s|_OIDC_AUTHORIZE_URL_|$OIDC_AUTHORIZE_URL|g; s|_OIDC_JWKS_URL_|$OIDC_JWKS_URL|g; s|_OIDC_ISSUER_|$OIDC_ISSUER|g; s|_OIDC_TOKEN_URL_|$OIDC_TOKEN_URL|g; s|_OIDC_USER_INFO_|$OIDC_USER_INFO|g; s|_OIDC_CLIENT_ID_|$OIDC_CLIENT_ID|g; s|_OIDC_AUDIENCE_|$OIDC_AUDIENCE|g; s|_OIDC_REDIRECT_URL_|$OIDC_REDIRECT_URL|g; s|_OIDC_SCOPE_|$OIDC_SCOPE|g; s|_OIDC_RESPONSE_TYPE_|$OIDC_RESPONSE_TYPE|g;" > $TOMCAT_CONFIG_PATH/$TOMCAT_DEPLOY_PATH.xml
if [ "$?" -ne 0 ]; then
